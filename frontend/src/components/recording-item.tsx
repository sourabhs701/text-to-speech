...
export function RecordingItem({ recording, isPlaying, onPlay, onDelete }: RecordingItemProps) {
    ...
    return (
        <div className={`bg-card border-b rounded-lg p-4 transition-colors ${!recording.isRead ? 'border-l-4 border-l-blue-500' : ''}`}>
            <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 text-xs text-muted-foreground min-w-xs pt-4">
